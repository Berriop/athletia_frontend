...
// diagramas "RF-12 Front (MealsPage.handleSubmit)" (Patrón C, V(G)=3,
// compartido con RF-10) y "RF-13 Front (MealsPage.confirmDelete)" (Patrón D,
// V(G)=4). Ver la nota sobre `addNotification`/Header en SleepPage.test.tsx.
...
describe('MealsPage.handleSubmit (RF-10 crear / RF-12 modificar)', () => {
  beforeEach(() => {
  ...
  it('RF-12: editando una comida existente → llama a update y notifica éxito', async () => {
    // Arrange
  ...
  // Camino de error (aplica a RF-10 y RF-12): INICIO,1,2,{3 ó 4},5,7,FIN
